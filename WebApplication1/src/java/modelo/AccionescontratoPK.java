...
public class AccionescontratoPK implements Serializable {
    ...
    public String toString() {
        return "modelo.AccionescontratoPK[ numerocontratoacciones=" + numerocontratoacciones + ", codigoclausulaacciones=" + codigoclausulaacciones + ", codigopagoacciones=" + codigopagoacciones + " ]";
    }
